...
EXPECTED_TOOL_NAMES = {
    ...
    # Channels
    "list_channels", "get_channel", "create_text_channel", "create_voice_channel",
    "create_category", "create_forum_channel", "edit_channel", "delete_channel",
    ...
    # Members
    "get_member", "list_members", "search_members", "kick_member", "ban_member",
    "unban_member", "timeout_member", "edit_member", "add_member_roles",
    "remove_member_roles", "send_dm",
    # Roles
    "list_roles", "get_role", "create_role", "edit_role", "delete_role",
    # Guilds
    "list_guilds", "get_guild", "edit_guild",
    # Webhooks
    "list_webhooks", "create_webhook", "send_webhook_message", "edit_webhook",
    "delete_webhook",
    # Invites
    "list_invites", "create_invite", "delete_invite", "get_invite",
    # Emojis
    "list_emojis", "create_emoji", "delete_emoji", "list_stickers", "delete_sticker",
    # Scheduled events
    "list_scheduled_events", "create_scheduled_event", "edit_scheduled_event",
...
class TestConnectTool:
    ...
    async def test_connect_uses_env_var(self, mcp_server):
        ...
        with (
            ...
            patch("discord_mcp.server.start_bot", new_callable=AsyncMock, return_value=mock_bot) as mock_start,
        ):
            from discord_mcp.server import connect
            result = await connect(token=None)

...
93 tools across 12 domains, built on [discord.py](https://discordpy.readthedocs.io)
...
| [Messages](docs/messages.md) | 13 | send, files, embeds, edit, delete, history, pins, reactions |
